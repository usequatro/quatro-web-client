...
const CardPositionedBoundaries = forwardRef(function CardPositionedBoundariesComponent(
  { id, allDay, height, width, coordinates, children, isDragging, isDropAnimating, draggableProps },
  ref,
) {
